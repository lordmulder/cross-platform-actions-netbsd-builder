...
curl -sSf https://cdn.netbsd.org/pub/NetBSD/NetBSD-11.0/i386/binary/sets/base.tgz | tar -C /opt/sysroot/i386 -xzf - lib usr/lib
curl -sSf https://cdn.netbsd.org/pub/NetBSD/NetBSD-11.0/i386/binary/sets/comp.tgz | tar -C /opt/sysroot/i386 -xzf - usr/lib
